...
from .interactive import analyze_incident, incident_catalog

app = FastAPI(title="RoadStar Sentinel", version="0.6.0")
...
<div class="wrap">
 ...
 <div class="panel scenario-lab">
  ...
  <div class="scenario-result">
   ...
   <div><div id="scenarioSummary" class="alert">Choose a disturbance and run it.</div><div id="scenarioRecs"></div></div>
  </div>
 </div>
